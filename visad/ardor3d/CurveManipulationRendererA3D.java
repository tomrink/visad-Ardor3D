 ...
 * dimension = 2
 */
public class CurveManipulationRendererA3D extends DirectManipulationRendererA3D {
   ...
   */
  public CurveManipulationRendererA3D () {
    this(0, 0);
  }
   ...
   */
  public CurveManipulationRendererA3D (int mmm, int mmv) {
    this(mmm, mmv, false);
  }
   ...
   */
  public CurveManipulationRendererA3D (int mmm, int mmv, boolean oo) {
    super();
  ...
  public ShadowType makeShadowSetType(
    ...
    return new ShadowCurveSetTypeA3D(type, link, parent);
  }
...
// System.out.println("drag_direct len = " + len + " which_set = " + which_set);
   ...
   */
  public Object clone() {
    return new CurveManipulationRendererA3D(mouseModifiersMask,
  ...
  public static void createAndShowGUI(String[] args)
    ...
    DefaultRendererA3D renderer = new DefaultRendererA3D();
    ...
    CurveManipulationRendererA3D cmr =
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (cmd.equals("del")) {
      ...
      try {
        ...
        if (new_ref == null) {
          ...
          DataRenderer renderer = 
              (display instanceof DisplayImplA3D)
                  ? (DataRenderer) new DefaultRendererA3D()
                  : (DataRenderer) new DefaultRendererA3D();
      ...
      try {
        ...
        GraphicsModeControl mode = display.getGraphicsModeControl();
        if (lines) {
          mode.setPolygonMode(DisplayImplA3D.POLYGON_LINE);
        }
        else {
          mode.setPolygonMode(DisplayImplA3D.POLYGON_FILL);
        }
      }
      catch (VisADException ex) {
        System.out.println(ex.getMessage());
