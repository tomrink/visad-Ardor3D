...
*/
public class GraphicsModeControlA3D extends GraphicsModeControl {
   ...
   */
  public GraphicsModeControlA3D(DisplayImpl d) {
    super(d);
    lineWidth = 1.0f;
    pointSize = 1.0f;
  ...
  public Object clone() {
    GraphicsModeControlA3D mode =
      new GraphicsModeControlA3D(getDisplay());
    ...
    throws VisADException
  {
    ...
    if (!(rmt instanceof GraphicsModeControlA3D)) {
      throw new VisADException("Cannot synchronize " + getClass().getName() +
                               " with " + rmt.getClass().getName());
    }

    GraphicsModeControlA3D rmtCtl = (GraphicsModeControlA3D )rmt;
  ...
  public boolean equals(Object o)
  {
    ...
    GraphicsModeControlA3D gmc = (GraphicsModeControlA3D )o;
