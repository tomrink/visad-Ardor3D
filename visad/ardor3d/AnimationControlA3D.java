...
public class AnimationControlA3D extends AVControlA3D
  ...
  public AnimationControlA3D(DisplayImplA3D d, RealType r) {
    ...
    stepValues = new long[] { DEFAULT_DWELL };
    try {
    ...
    throws VisADException
  {
    ...
    if (!(rmt instanceof AnimationControlA3D)) {
      throw new VisADException("Cannot synchronize " + getClass().getName() +
                               " with " + rmt.getClass().getName());
    }

    AnimationControlA3D ac = (AnimationControlA3D )rmt;
  ...
  public boolean equals(Object o)
  {
    ...
    AnimationControlA3D ac = (AnimationControlA3D )o;
