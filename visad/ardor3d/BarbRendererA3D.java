...
*/
public class BarbRendererA3D extends DefaultRendererA3D
       implements BarbRenderer {

  private BarbManipulationRendererA3D bmr;
  ...
  public BarbRendererA3D () {
    super();
    bmr = new BarbManipulationRendererA3D();
  }
  ...
  public static void main(String args[])
    ...
    if (args.length > 1) {
      ...
      RealTupleType flowds =
        ...
        new visad.bom.WindPolarCoordinateSystem(flowxy), null);
    ...
    DisplayImpl display = new DisplayImplA3D("display1");
    ...
    ref.setData(field);
    BarbRendererA3D renderer = new BarbRendererA3D();
