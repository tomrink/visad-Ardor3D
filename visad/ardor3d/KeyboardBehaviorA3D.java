...
*/
   ...
   */
  public KeyboardBehaviorA3D(DisplayRendererA3D r) {
    displayRenderer = r;
  ...
  // WLH 19 Feb 2001
  public KeyboardBehaviorA3D(DisplayRendererA3D r, int num_functions) {
    displayRenderer = r;
    boolean mode2D = displayRenderer.getMode2D();
    proj = displayRenderer.getDisplay().getProjectionControl();
    mouseBehavior = displayRenderer.getMouseBehavior();
  ...
  public void execFunction(int function) {
    ...
    MouseBehaviorA3D.unmake_matrix(rotA,  scaleA,
                                   transA,tstart);
