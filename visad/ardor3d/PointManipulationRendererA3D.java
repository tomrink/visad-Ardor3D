...
*/
public class PointManipulationRendererA3D extends DirectManipulationRendererA3D {
  ...
  public PointManipulationRendererA3D (RealType xarg, RealType yarg) {
  ...
  public PointManipulationRendererA3D (RealType xarg, RealType yarg, int mmm, int mmv) {
    super();
    x = xarg;
    y = yarg;
  ...
  */
  ...
  public synchronized void drag_direct(VisADRay ray, boolean first,
    ...
    try {
      ...
      if (r != r) {
        if (group != null) {
           group.getParent().detachChild(group);
        }
        return;
      }
  ...
  public Object clone() {
    return new PointManipulationRendererA3D(x, y, mouseModifiersMask,
                                            mouseModifiersValue);
  }
  ...
  public static void createAndShowGUI(String args[])
    ...
    display.addReferences(new PointManipulationRendererA3D(x, y, m, m), ref);
