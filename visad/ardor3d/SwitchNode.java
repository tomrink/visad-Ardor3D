...
//    Don't do this for now. Just use top-level which updates all of the children (at once, I think). This
//    seems to eliminate the flicking, or what seems like briefly seeing a past transform state, when changing
//    the root transform and animating at the same time.
//    @Override
