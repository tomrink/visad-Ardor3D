...
/**
   DefaultRendererA3D is the VisAD class for the default graphics
   rendering algorithm under JOGAMP Ardor3D.<P>
*/
public class DefaultRendererA3D extends RendererA3D {

  DataDisplayLink link = null;

  /** this is the default DataRenderer used by the addReference method
      for DisplayImplJ3D */
  public DefaultRendererA3D () {
    super();
  }
