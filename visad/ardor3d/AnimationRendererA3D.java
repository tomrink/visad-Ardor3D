...
public class AnimationRendererA3D extends DefaultRendererA3D {
  ...
  public ShadowType makeShadowFunctionType(
    ...
    return new ShadowAnimationFunctionTypeA3D(type, link, parent);
  }
  ...
  public Object clone() {
    return new AnimationRendererA3D();
  }
  ...
  public static void main(String args[])
    ...
    acontrol.setOn(true);
    acontrol.setStep(200);

    DataReferenceImpl ref = new DataReferenceImpl("field_ref");
    ref.setData(field);
    AnimationRendererA3D renderer = new AnimationRendererA3D();
