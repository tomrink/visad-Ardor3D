 ...
 * ((latitude, longitude)->(text))
 */
public class ScreenLockedRendererA3D extends DefaultRendererA3D 
{
   ...
   * Default constructor.
   */
  public ScreenLockedRendererA3D()
  {
    super();
  }

  public ScreenLockedRendererA3D(boolean initWithProj) {
    this();
    ...
    throws VisADException, RemoteException
  {
    ...
    gmc.setProjectionPolicy(DisplayImplA3D.PARALLEL_PROJECTION);
    ...
    display.addReferences(new ScreenLockedRendererA3D(), lockedDataRef1,
    	new ConstantMap[]{
    ...
    display.addReferences(new ScreenLockedRendererA3D(), lockedDataRef2,
    	new ConstantMap[]{
		new ConstantMap(1.0, Display.XAxis),
		new ConstantMap(-1.0, Display.YAxis),
		new ConstantMap(-0.2, Display.ZAxis)});
