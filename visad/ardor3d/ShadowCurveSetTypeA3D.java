...
*/
public class ShadowCurveSetTypeA3D extends ShadowSetTypeA3D {
   ...
   */
  public ShadowCurveSetTypeA3D(MathType t, DataDisplayLink link,
                                ShadowType parent)
  ...
  public boolean doTransform(Object group, Data data, float[] value_array,
    ...
    ((CurveManipulationRendererA3D) renderer).default_values = default_values;
