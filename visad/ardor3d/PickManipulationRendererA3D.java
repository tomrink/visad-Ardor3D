//
// PickManipulationRendererA3D.java
//
...
/**
 * PickManipulationRendererA3D is the VisAD class for picking
 * data in 3D.
 */
public class PickManipulationRendererA3D extends DirectManipulationRendererA3D {
   ...
   * Default constructor
   */
  public PickManipulationRendererA3D () {
    this (0, 0);
  }
   ...
   */
  public PickManipulationRendererA3D (int mmm, int mmv) {
    super();
...
*/
  ...
  public Object clone() {
    return new PickManipulationRendererA3D(mouseModifiersMask,
                                           mouseModifiersValue);
  }

  /** test PickManipulationRendererA3D */
  ...
  public static void createAndShowGUI(String[] args)
    ...
    DisplayImpl display = new DisplayImplA3D("display", frame, panel, DisplayImplA3D.JOGL_AWT);
    ...
    tref.setData(text);
    display.addReferences(new PickManipulationRendererA3D(), tref);
    ...
    sref.setData(shape);
    display.addReferences(new PickManipulationRendererA3D(), sref);
    ...
    display.addReferences(new PickManipulationRendererA3D(), rref, rmaps);
    ...
    display.addReferences(new PickManipulationRendererA3D(), rtref, rtmaps);
    ...
    final PickManipulationRendererA3D pmr1d = new PickManipulationRendererA3D();
    ...
    final PickManipulationRendererA3D pmr2d = new PickManipulationRendererA3D();
    ...
    final PickManipulationRendererA3D pmrset = new PickManipulationRendererA3D();
