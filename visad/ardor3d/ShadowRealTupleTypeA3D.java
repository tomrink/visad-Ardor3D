...
*/
public class ShadowRealTupleTypeA3D extends ShadowTupleTypeA3D {

  public ShadowRealTupleTypeA3D(MathType t, DataDisplayLink link,
                                ShadowType parent)
         throws VisADException, RemoteException {
    super(t, link, parent);
        int n = ((TupleType) t).getDimension();
    tupleComponents = new ShadowRealTypeA3D[n];
    ShadowRealType[] components = new ShadowRealType[n];
    for (int i=0; i<n; i++) {
      ShadowRealTypeA3D shadow = (ShadowRealTypeA3D)
